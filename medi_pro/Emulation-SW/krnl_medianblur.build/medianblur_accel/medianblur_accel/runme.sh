...
HD_PWD='/home/centos/workspace/medi_pro/Emulation-SW/krnl_medianblur.build/medianblur_accel/medianblur_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f medianblur_accel.tcl -messageDb vitis_hls.pb
