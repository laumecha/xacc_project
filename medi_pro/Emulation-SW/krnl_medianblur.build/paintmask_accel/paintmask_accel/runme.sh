...
HD_PWD='/home/centos/workspace/medi_pro/Emulation-SW/krnl_medianblur.build/paintmask_accel/paintmask_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f paintmask_accel.tcl -messageDb vitis_hls.pb
